...
!MESSAGE "Test - Win32 Release MinSize" (based on "Win32 (x86) Application")
!MESSAGE "Test - Win32 Release MinDependency" (based on "Win32 (x86) Application")
!MESSAGE "Test - Win32 Unicode Release MinSize" (based on "Win32 (x86) Application")
!MESSAGE "Test - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /nologo /W3 /Gm /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib comsupp.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept
# Begin Custom Build - Performing registration
OutDir=.\Debug
TargetPath=.\Debug\Test.exe
InputPath=.\Debug\Test.exe
SOURCE="$(InputPath)"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\Test.exe
InputPath=.\DebugU\Test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinSize\Test.exe
InputPath=.\ReleaseMinSize\Test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinDependency\Test.exe
InputPath=.\ReleaseMinDependency\Test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinSize\Test.exe
InputPath=.\ReleaseUMinSize\Test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinDependency\Test.exe
InputPath=.\ReleaseUMinDependency\Test.exe
SOURCE="$(InputPath)"
...
SOURCE=.\Test.idl
# ADD MTL /tlb ".\Test.tlb" /h "Test.h" /iid "Test_i.c" /Oicf
# End Source File
# Begin Source File
